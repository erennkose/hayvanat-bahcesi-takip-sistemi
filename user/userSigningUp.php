...
<br>
    ...
    <?php
        ...
        if($username == null || $tcno == null || $email == null || $fname == null || $lname == null || $phone == null || $bday == null || $password == null) {
            ...
            $checkQuery = "SELECT * FROM users WHERE User_Name='$username' OR Tc_No='$tcno' OR E_Mail='$email' OR GSM_No='$phone'";
            ...
            if ($result->num_rows > 0) {
                ...
                $sqlQuery = "INSERT INTO users(User_Name, Tc_No, E_Mail, First_Name, Last_Name, GSM_No, Birth_Date, Password)

    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm">
                ...
                <a href="../admin/adminRegister.php"><button type="button" class="btn btn-primary" style="text-align:right;">Admin Kayıt</button></a>
                </div>
            </div>
        </div>
        <!-- Ust Panel -->
        <br>
        <div class="jumbotron">
            <h3 style="text-align:center;" class="display-4">Üye Kayıt</h3>
            <hr class="my-4">

            <!-- Form Kismi -->
            <form action="userSigningUp.php" method="POST">

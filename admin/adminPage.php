...
<body>
    <?php
        session_start();
        /* eger $_SESSION["type"] yoksa veya user ise bu sayfaya erismesini engelledim ve index.php sayfasina yonlendirdim */  
    ...
    <div class="container">
        ...
        <br>
        <div class="jumbotron">
            <h3 style="text-align:center;" class="display-4">Admin İşlemleri</h3>
            <hr class="my-4">
            <form style="text-align:center;" action="userCheck.php" method="POST">
                <a href="../user/showUsers.php"><button type="button" class="btn btn-primary">Kayıtlı Üyeleri Görüntüle</button></a>
